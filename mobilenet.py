...
class _MobileNet:
    ...
    def __call__(self):
        ...
        mobilenet = MobileNet(input_shape=(128,128,3), input_tensor=input_image, alpha = 0.5, weights = None, include_top=False, backend=keras.backend, layers=keras.layers, models=keras.models, utils=keras.utils)
        # Classifier block
        ...
        predictions_a = Dense(101, activation="softmax", name="pred_age")(fc_a)
